                      ...
                      <div className="flex items-center space-x-6 mt-auto">
                        {project.links?.live && project.links.live !== "#" && (
                          <a 
                            ...
                            onClick={() => trackEvent("project_click", { projectTitle: project.title, linkType: "live" })}
                          >
                        ...
                        {project.links?.repo && project.links.repo !== "#" && (
                          <a 
                            ...
                            onClick={() => trackEvent("project_click", { projectTitle: project.title, linkType: "repo" })}
                          >
                            <GithubIcon size={18} />
                        ...
                        {project.links?.demo && project.links.demo !== "#" && (
                          <a 
                            ...
                            rel="noopener noreferrer" 
                            className="flex items-center space-x-2 text-zinc-400 hover:text-white transition-colors"
                            onClick={() => trackEvent("project_click", { projectTitle: project.title, linkType: "demo" })}
                          >
                            <PlayCircle size={18} />
