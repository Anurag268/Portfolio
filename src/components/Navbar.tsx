    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="/api/resume" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-full bg-white text-black font-medium hover:bg-zinc-200 transition-colors">
            Resume
          </a>
        </nav>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            <a href="/api/resume" target="_blank" rel="noopener noreferrer" className="px-6 py-3 rounded-full bg-white text-black font-medium hover:bg-zinc-200 transition-colors w-11/12 text-center mt-4" onClick={() => setMobileMenuOpen(false)}>
              Resume
            </a>
          </motion.div>
        )}
